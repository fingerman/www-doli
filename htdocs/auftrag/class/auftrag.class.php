 ...
 *  \ingroup    auftrag othermodule1 othermodule2
 ...
 */
class auftrag extends CommonObject
{
	var $db;							//!< To store db handler
	var $error;							//!< To return error code (or message)
	var $errors=array();				//!< To return several error codes (or messages)
	var $element='auftrag';			//!< Id that identify managed objects
	var $table_element='auftrag';		//!< Name of table without prefix where object is stored
    var $id;
    var $prop1;
    var $prop2;
	//...
