 ...
 *  \ingroup    medical24 othermodule1 othermodule2
 ...
 */
class medical24 extends CommonObject
{
	var $db;							//!< To store db handler
	var $error;							//!< To return error code (or message)
	var $errors=array();				//!< To return several error codes (or messages)
	var $element='medical24';			//!< Id that identify managed objects
	var $table_element='medical24';		//!< Name of table without prefix where object is stored
    var $id;
    var $prop1;
    var $prop2;
	//...
