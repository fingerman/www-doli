...
$var=!$var;
showConf('FOURN_PRODUCT_AVAILABILITY', $langs->trans("FOURN_PRODUCT_AVAILABILITY"), $langs->trans("FOURNPRODUCTAVAILABILITY"),$bc[$var]);
$var=!$var;
showConf('SUPPLIER_ORDER_AUTOADD_USER_CONTACT', $langs->trans("SUPPLIER_ORDER_AUTOADD_USER_CONTACT"), $langs->trans("SUPPLIERORDERAUTOADDUSERCONTACT"),$bc[$var]);
$var=!$var;
$version = version_dolibarr();
if($version>=4.0)
showConf('SUPPLIER_ORDER_USE_DISPATCH_STATUS', $langs->trans("SUPPLIER_ORDER_USE_DISPATCH_STATUS"), $langs->trans("SUPPLIERORDERUSEDISPATCHSTATUS"),$bc[$var]);
$var=!$var;
showConf('SUPPLIER_ORDER_NO_DIRECT_APPROVE', $langs->trans("SUPPLIER_ORDER_NO_DIRECT_APPROVE"), $langs->trans("SUPPLIERORDERNODIRECTAPPROVE"),$bc[$var]);
$var=!$var;
if($version>=6.0){
showConf('SUPPLIER_ORDER_WITH_NOPRICEDEFINED', $langs->trans("SUPPLIER_ORDER_WITH_NOPRICEDEFINED"), $langs->trans("SUPPLIERORDERWITHNOPRICEDEFINED"),$bc[$var]);
$var=!$var;
showConf('SUPPLIER_ORDER_EDIT_BUYINGPRICE_DURING_RECEIPT', $langs->trans("SUPPLIER_ORDER_EDIT_BUYINGPRICE_DURING_RECEIPT"), $langs->trans("SUPPLIERORDEREDITBUYINGPRICEDURINGRECEIPT"),$bc[$var]);
}
