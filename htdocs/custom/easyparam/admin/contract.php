...
dol_fiche_head($head,'contract',  $langs->trans("EasyParam"),
    0,
    "easyparam@easyparam"
);
...
$var=!$var;
showConf('CONTRACT_SUPPORT_PRODUCTS', $langs->trans("CONTRACT_SUPPORT_PRODUCTS"), $langs->trans("CONTRACTSUPPORTPRODUCTS"),$bc[$var]);
$var=!$var;
