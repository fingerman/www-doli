...
$var=!$var;
showConf('STOCK_SUPPORTS_SERVICES', $langs->trans("STOCK_SUPPORTS_SERVICES"), $langs->trans("STOCKSUPPORTSSERVICES"),$bc[$var]);
$var=!$var;
showConf('SUPPLIER_ORDER_DISABLE_STOCK_DISPATCH_WHEN_TOTAL_REACHED', $langs->trans("SUPPLIER_ORDER_DISABLE_STOCK_DISPATCH_WHEN_TOTAL_REACHED"), $langs->trans("SUPPLIERORDERDISABLESTOCKDISPATCHWHENTOTALREACHED"),$bc[$var]);
