...
dol_fiche_head($head,'cashdesk',  $langs->trans("EasyParam"),
    0,
    "easyparam@easyparam"
);
...
$var=!$var;
showConf('CASHDESK_SHOW_KEYPAD', $langs->trans("CASHDESK_SHOW_KEYPAD"), $langs->trans("CASHDESKSHOWKEYPAD"),$bc[$var]);
$var=!$var;
