...
dol_fiche_head($head,'bank',  $langs->trans("EasyParam"),
    0,
    "easyparam@easyparam"
);
...
$var=!$var;
showConf('BANK_CAN_RECONCILIATE_CASHACCOUNT', $langs->trans("BANK_CAN_RECONCILIATE_CASHACCOUNT"), $langs->trans("BANKCANRECONCILIATECASHACCOUNT"),$bc[$var]);
$var=!$var;
showConf('BANK_DISABLE_CHECK_DEPOSIT', $langs->trans("BANK_DISABLE_CHECK_DEPOSIT"), $langs->trans("BANKDISABLECHECKDEPOSIT"),$bc[$var]);
$var=!$var;
showConf('BANK_ASK_PAYMENT_BANK_DURING_ORDER', $langs->trans("BANK_ASK_PAYMENT_BANK_DURING_ORDERS"), $langs->trans("BANKASKPAYMENTBANKDURINGORDER"),$bc[$var]);
