...
$var=!$var;
showConf('MAIN_OPTIMIZEFORTEXTBROWSER', $langs->trans("MAIN_OPTIMIZEFORTEXTBROWSER"), $langs->trans("MAINOPTIMIZEFORTEXTBROWSER"),$bc[$var]);
$var=!$var;
showConf("THEME_ELDY_DISABLE_IMAGE", $langs->trans("THEME_ELDY_DISABLE_IMAGE"), $langs->trans("THEMEELDYDISABLEIMAGE"),$bc[$var]);
$var=!$var;
showConf("MAIN_MENU_HIDE_UNAUTHORIZED", $langs->trans("MAIN_MENU_HIDE_UNAUTHORIZED"), $langs->trans("MAINMENUHIDEUNAUTHORIZED"),$bc[$var]);
