...
dol_fiche_head($head,'agenda',  $langs->trans("EasyParam"),
    0,
    "easyparam@easyparam"
);
...
$var=!$var;
showConf('MAIN_ADD_EVENT_ON_ELEMENT_CARD', $langs->trans("MAIN_ADD_EVENT_ON_ELEMENT_CARD"), $langs->trans("MAINADDEVENTONELEMENTCARD"),$bc[$var]);
$var=!$var;
showConf('AGENDA_USE_EVENT_TYPE', $langs->trans("AGENDA_USE_EVENT_TYPE"), $langs->trans("AGENDAUSEEVENTTYPE"),$bc[$var]);


$var=!$var;
print '<tr '.$bc[$var].'>';
print '<td>AGENDA_MAX_EVENTS_DAY_VIEW</td><td>'.$langs->trans("AGENDAMAXEVENTSDAYVIEW").'<td><input type="text" name="AGENDA_MAX_EVENTS_DAY_VIEW" value="'.$conf->global->AGENDA_MAX_EVENTS_DAY_VIEW.'" />';
print '</td></tr>';
$var=!$var;
print '<tr '.$bc[$var].'>';
print '<td>AGENDA_AUTOSET_END_DATE_WITH_DELTA_HOURS</td><td>'.$langs->trans("AGENDAAUTOSETENDDATEWITHDELTAHOURS").'<td><input type="text" name="AGENDA_AUTOSET_END_DATE_WITH_DELTA_HOURS" value="'.$conf->global->AGENDA_AUTOSET_END_DATE_WITH_DELTA_HOURS.'" />';
print '</td></tr>';
$var=!$var;
