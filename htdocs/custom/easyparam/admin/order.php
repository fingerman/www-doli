...
dol_fiche_head($head,'order',  $langs->trans("EasyParam"),
    0,
    "easyparam@easyparam"
);
...
$var=!$var;
showConf('COMMANDE_REQUIRE_SOURCE', $langs->trans("COMMANDE_REQUIRE_SOURCE"), $langs->trans("COMMANDEREQUIRESOURCE"),$bc[$var]);
$var=!$var;
showConf("COMMANDE_VALID_AFTER_CLOSE_PROPAL", $langs->trans("COMMANDE_VALID_AFTER_CLOSE_PROPAL"), $langs->trans("COMMANDEVALIDAFTERCLOSEPROPAL"),$bc[$var]);
$var=!$var;
showConf('COMMANDE_CHANGE_THIRDPARTY', $langs->trans("COMMANDE_CHANGE_THIRDPARTY"), $langs->trans("COMMANDECHANGETHIRDPARTY"),$bc[$var]);
