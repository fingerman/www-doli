...
dol_fiche_head($head,'project',  $langs->trans("EasyParam"),
    0,
    "easyparam@easyparam"
);
...
$var=!$var;
showConf('PROJECT_CAN_ALWAYS_LINK_TO_ALL_SUPPLIERS', $langs->trans("PROJECT_CAN_ALWAYS_LINK_TO_ALL_SUPPLIERS"), $langs->trans("PROJECTCANALWAYSLINKTOALLSUPPLIERS"),$bc[$var]);
$var=!$var;
showConf('PROJECT_TIME_ON_ALL_TASKS_MY_PROJECTS', $langs->trans("PROJECT_TIME_ON_ALL_TASKS_MY_PROJECTS"), $langs->trans("PROJECTTIMEONALLTASKSMYPROJECTS"),$bc[$var]);
$var=!$var;
showConf('PROJECT_SHOW_REF_INTO_LISTS', $langs->trans("PROJECT_SHOW_REF_INTO_LISTS"), $langs->trans("PROJECTSHOWREFINTOLISTS"),$bc[$var]);
$var=!$var;
showConf('PROJECT_HIDE_UNSELECTABLES', $langs->trans("PROJECT_HIDE_UNSELECTABLES"), $langs->trans("PROJECTHIDEUNSELECTABLES"),$bc[$var]);
$var=!$var;
showConf('PROJECT_HIDE_TASKS', $langs->trans("PROJECT_HIDE_TASKS"), $langs->trans("PROJECTHIDETASKS"),$bc[$var]);
$var=!$var;
showConf('PROJECT_LIST_SHOW_STARTDATE', $langs->trans("PROJECT_LIST_SHOW_STARTDATE"), $langs->trans("PROJECTLISTSHOWSTARTDATE"),$bc[$var]);
$var=!$var;
if(version_dolibarr()>=4){
showConf('PROJECT_LINK_ON_OVERWIEW_DISABLED', $langs->trans("HPROJECT_LINK_ON_OVERWIEW_DISABLED"), $langs->trans("HPROJECTLINKONOVERWIEWDISABLED"),$bc[$var]);
$var=!$var;
showConf('PROJECT_CREATE_ON_OVERVIEW_DISABLED', $langs->trans("PROJECT_CREATE_ON_OVERVIEW_DISABLED"), $langs->trans("PROJECTCREATEONOVERVIEWDISABLED"),$bc[$var]);
$var=!$var;
}
$var=!$var;
showConf('PROJECT_ALLOW_TO_LINK_FROM_OTHER_COMPANY', $langs->trans("PROJECT_ALLOW_TO_LINK_FROM_OTHER_COMPANY"), $langs->trans("PROJECTALLOWTOLINKFROMOTHERCOMPANY"),$bc[$var]);
/*
$var=!$var;
print '<tr '.$bc[$var].'>';
