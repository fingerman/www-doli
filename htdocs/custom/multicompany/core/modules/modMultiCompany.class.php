...
class modMultiCompany extends DolibarrModules
{
	...
	function __construct($db)
	{
		...
		$this->need_dolibarr_version = array(6,0,0);	// Minimum version of Dolibarr required by module
	...
	{
		$sql = array(
				"DELETE FROM ".MAIN_DB_PREFIX."const WHERE name = 'MAIN_MODULE_MULTICOMPANY_CSS'",
				"DELETE FROM ".MAIN_DB_PREFIX."const WHERE name = 'MAIN_MODULE_MULTICOMPANY_LOGIN'"
		);
	...
	*/
	...
	/**
	 * Add default dictionnaries for all entities
	 *
	 * @return int
	 */
	function setDefaultDicts()
	{
		dol_include_once('/multicompany/class/actions_multicompany.class.php', 'ActionsMulticompany');

		$dicts = new ActionsMulticompany($this->db);
		return $dicts->addAllEntitiesDefaultDicts();
	}
}
