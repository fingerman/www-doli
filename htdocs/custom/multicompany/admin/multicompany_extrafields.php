 ...
 * Copyright (C) 2016-2017	Regis Houssin	<regis.houssin@inodbox.com>
 *
...
dol_fiche_head($head, 'attributes', $langs->trans("ModuleSetup"));

print $langs->trans("DefineHereComplementaryAttributes", $langs->transnoentitiesnoconv("Module5000Name")) . '<br>' . "\n";
print '<br>';
