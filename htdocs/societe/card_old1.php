...
*/
	...
	print '<td colspan="3"><input type="text" id="abw_plz" name="abw_plz" value="" style="width: 120px" /> Ort <input type="text" id="abw_ort" name="abw_ort" value="" style="width: 160px" /></td></tr>';
	...
	print '<td colspan="3"><input type="text" id="abwr_plz" name="abwr_plz" value="" style="width: 120px" /> Ort <input type="text" id="abw_ort" name="abwr_ort" value="" style="width: 160px" /></td></tr>';
        ...
        print   /// popup dialog angehöriger      
               ...
               // " <p>Bitte ausfüllen</p>\n" . 
                ...
                "\$('input[name=options_verordner]').on('keyup select', function(){\n" .         /// Verordner ID    "\$('input[name=options_verordner]').on('keyup change select', function(){\n" .
