...
else
{
    ...
    if ($action == 'create')
    {
        ...
        print load_fiche_titre(("Neuer Lieferant"),$linkback,'title_companies.png');
        ...
        if ($object->particulier || $private)
        {
	        print '<span id="TypeName" class="fieldrequired">Lieferant / '.$langs->trans('LastName','name').'</span>';
        }
        else
		{
...
*/
        ...
        // Vat is used
        print '<tr><td>'.fieldLabel('VATIsUsed','assujtva_value').'</td>';   //**p** 
        print '<td>';
        ...
        Print '<select id="typent_id" class="flat typent_id" name="typent_id"><option value="0">--</option>
                ...
                <option selected value="104">Lieferant</option>
		...
		if (! empty($conf->categorie->enabled)  && ! empty($user->rights->categorie->lire))
		{
			...
			if ($object->prospect || $object->client) {
				...
				print $form->multiselectarray('custcats', $cate_arbo, GETPOST('custcats', 'array'), null, null, null,null, "90%");
                                //print $form->multiselectarray('custcats', $cate_arbo, array(0=>14), null, null, null,null, "90%"); //array(0=>13) bedeutet 13 Element vom Tag select Kundenkategorie **p**
				print "</td></tr>";
			}

			// Supplier
			if ($object->fournisseur) {
				print '<tr style="display:none"><td class="toptd">' . fieldLabel('SuppliersCategoriesShort', 'suppcats') . '</td><td colspan="3">';
				$cate_arbo = $form->select_all_categories(Categorie::TYPE_SUPPLIER, null, 'parent', null, null, 1);
				//print $form->multiselectarray('suppcats', $cate_arbo, GETPOST('suppcats', 'array'), null, null, null,null, "90%");
                                print $form->multiselectarray('suppcats', $cate_arbo, array(0=>4), null, null, null,null, "90%");
				print "</td></tr>";
			}
		}
		...
		else
		{
	        ...
	        if (empty($conf->global->SOCIETE_DISABLE_CONTACTS))
	        {
	            //$result=show_contacts($conf,$langs,$db,$object,$_SERVER["PHP_SELF"].'?socid='.$object->id);
                    $result=show_contacts4($conf,$langs,$db,$object,$_SERVER["PHP_SELF"].'?socid='.$object->id);    // **p** um auf die card2.php in show_contacts2 umbenannt
	        }
