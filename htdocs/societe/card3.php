...
else
{
    ...
    if ($action == 'create')
    {
        ...
        print load_fiche_titre(("Neuer Gesundheitsdienstleister"),$linkback,'title_companies.png');
...
*/
        ...
        Print '<select id="typent_id" class="flat typent_id" name="typent_id"><option value="0">--</option>
                <option selected value="101">Gesundheitsdienstleister</option>
...
*/
		...
		if (! empty($conf->categorie->enabled)  && ! empty($user->rights->categorie->lire))
		{
			...
			if ($object->prospect || $object->client) {
				...
				//print $form->multiselectarray('custcats', $cate_arbo, GETPOST('custcats', 'array'), null, null, null,null, "90%");
                                print $form->multiselectarray('custcats', $cate_arbo, array(0=>1), null, null, null,null, "90%"); //array(0=>13) bedeutet 13 Element vom Tag select Kundenkategorie **p**
				print "</td></tr>";
			}
		...
		print 	"<script>\n" . 
                        ...
                        "\$('.societe_extras_krankenkasse').hide();\n" .
		...
		else
		{
	        ...
	        if (empty($conf->global->SOCIETE_DISABLE_CONTACTS))
	        {
	            //$result=show_contacts($conf,$langs,$db,$object,$_SERVER["PHP_SELF"].'?socid='.$object->id);
                    $result=show_contacts3($conf,$langs,$db,$object,$_SERVER["PHP_SELF"].'?socid='.$object->id);    // **p** um auf die card2.php in show_contacts2 umbenannt
	        }
