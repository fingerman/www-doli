 ...
 */
class Societe2 extends CommonObject  // **p** class Societe extends CommonObject 
{
    ...
    function getNomUrl($withpicto=0, $option='', $maxlen=0, $notooltip=0, $save_lastsearch_value=-1)
    {
        ...
        // By default    **p** Linkänderung
        if (empty($linkstart))
        {
            $label.= '<u>' . $langs->trans("ShowCompany") . '</u>';
            $linkstart = '<a href="'.DOL_URL_ROOT.'/societe/card2.php?socid='.$this->id;
        }
