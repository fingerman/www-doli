...
$search_categ_cus=trim(GETPOST("search_categ_cus",'int'));$search_categ_cus = $search_categ_cus != "" ? $search_categ_cus : 1; ///Kundenkategorie value 11
...
$companystatic=new Societe3($db);  //**p**  $companystatic=new Societe($db);
