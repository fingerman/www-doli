...
$search_categ_sup=trim(GETPOST("search_categ_sup",'int'));$search_categ_sup = $search_categ_sup != "" ? $search_categ_sup : 4; ///Kundenkategorie value 11
