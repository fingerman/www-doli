            ...
            if ($action == 'add')
            {
                ...
                if ($result >= 0)
                {
                	...
                	else
                	{
                    	...
                    	if (($object->client == 1 || $object->client == 3) && empty($conf->global->SOCIETE_DISABLE_CUSTOMERS)) $url=DOL_URL_ROOT."/comm/card2.php?socid=".$object->id; // $url=DOL_URL_ROOT."/comm/card.php?socid  **p
...
else
{
    ...
    if ($action == 'create')
    {
		...
		if (! empty($conf->global->THIRDPARTY_DEFAULT_CREATE_CONTACT) && ! isset($_GET['private']) && ! isset($_POST['private'])) $private=0;  //**p**  default $private=1;
        ...
        print load_fiche_titre(("Neuer Verordner"),$linkback,'title_companies.png');
        ...
        if ($object->particulier || $private)
        {
	        print '<span id="TypeName" class="fieldrequired">Verordner / '.$langs->trans('LastName','name').'</span>';
        }
        else
		{
        ...
        // Prospect/Customer
        print '<tr style="display:none"><td class="titlefieldcreate">'.fieldLabel('ProspectCustomer','customerprospect',1).'</td>';
...
*/
        // Vat is used
        print '<tr style="display:none"><td>'.fieldLabel('VATIsUsed','assujtva_value').'</td>';   //**p** 
        print '<td>';
        ...
        Print '<select id="typent_id" class="flat typent_id" name="typent_id"><option value="0">--</option>
                ...
                <option value="103">Kunde</option>
                <option value="104">Lieferant</option>
                <option selected value="102">Verordner</option>
                </select>';
...
*/
		...
		if (! empty($conf->categorie->enabled)  && ! empty($user->rights->categorie->lire))
		{
			...
			if ($object->prospect || $object->client) {
				...
				//print $form->multiselectarray('custcats', $cate_arbo, GETPOST('custcats', 'array'), null, null, null,null, "90%");
                                print $form->multiselectarray('custcats', $cate_arbo, array(0=>3), null, null, null,null, "90%"); //array(0=>13) bedeutet 13 Element vom Tag select Kundenkategorie
				print "</td></tr>";
			}
		...
		print 	"<script>\n" . 
                        ...
                        "\$('.societe_extras_krankenkassen').hide();\n" .
                        "\$('.societe_extras_krankenkasse_mitgliedsnr').hide();\n" .
                        "\$('.societe_extras_krankenkasse_karte_gueltig').hide();\n" .
                        "\$('.societe_extras_versichertenstatus').hide();\n" .
                        "\$('.societe_extras_mitgliedsstatus').hide();\n" .
                        "\$('.societe_extras_zuzahlung').hide();\n" .
                        "\$('.societe_extras_zuzahlungsbefreit_datum').hide();\n" .
                        "\$('.societe_extras_pflegekasse').hide();\n" .
                        "\$('.societe_extras_berufsgenossenschaft').hide();\n" .
                        "\$('.societe_extras_gesetzl_betreuer').hide();\n" .
                        "\$('.societe_extras_gesetzl_betreuer_str').hide();\n" .
                        "\$('.societe_extras_gesetzl_betreuer_plz').hide();\n" .
                        "\$('.societe_extras_gesetzl_betreuer_ort').hide();\n" .
                        "\$('.societe_extras_angehoeriger').hide();\n" .
                        "\$('.societe_extras_angehoeriger_strasse').hide();\n" .
                        "\$('.societe_extras_angehoeriger_plz').hide();\n" .
                        "\$('.societe_extras_angehoeriger_ort').hide();\n" .
                        "\$('.societe_extras_verordner').hide();\n" .
                        "\$('.societe_extras_pflegegrad').hide();\n" .
                        "\$('.societe_extras_sterbevermerk').hide();\n" .
                        "\$('.societe_extras_liefervermerk').hide();\n" .
                        "\$('.societe_extras_verordner_betreuer').hide();\n" .
                        "\$('.societe_extras_verordner_id').hide();\n" . 
                        ...
                        "\$('.societe_extras_gesetzl_betreuer_anrede').hide();\n" . 
                        "\$('.societe_extras_gesetzl_betreuer_vorname').hide();\n" . 
                        "\$('.societe_extras_gesetzl_betreuer_name').hide();\n" .

                        "\$('.societe_extras_gesetzl_betreuer_tel').hide();\n" .
                        "\$('.societe_extras_gesetzl_betreuer_mobil').hide();\n" .
                        "\$('.societe_extras_gesetzl_betreuer_email').hide();\n" .
                        "\$('.societe_extras_angehoeriger_vorname').hide();\n" . 
                        "\$('.societe_extras_angehoeriger_name').hide();\n" .
                        "\$('.societe_extras_angehoeriger_telefon').hide();\n" .
                        "\$('.societe_extras_angehoeriger_mobilfunk').hide();\n" .
                        "\$('.societe_extras_angehoeriger_email').hide();\n" .
                        "\$('.societe_extras_geschlecht').hide();\n" .
                        "\$('.societe_extras_geburtsdatum').hide();\n" . 
                        ...
                        "\$('#options_verordner_fachrichtung').load('../request.php', {'hauptkategorie': 1});\n" . ///// Multiselect Fachrichtung
                        "\$('#options_verordner_fachr_unterk').load('../request.php', {'nix': 0});\n" . 
                        "\$('#options_verordner_fachrichtung').on('change', function(){\n" .  ///// Multiselect
                        " var pid = $(this).children('option:selected').val();\n" . 
                        " \$('#options_verordner_fachr_unterk').load('../request.php', {'unterkategorie': pid});\n" . 
                        "});\n" . 
                        " \$('#options_verordner_fachrichtung').css({'width': '350px'});\n" . 
                        " \$('#options_verordner_fachr_unterk').css({'width': '350px'});\n" . 
		...
		else
		{
	        ...
	        if (empty($conf->global->SOCIETE_DISABLE_CONTACTS))
	        {
	            //$result=show_contacts($conf,$langs,$db,$object,$_SERVER["PHP_SELF"].'?socid='.$object->id);
                    $result=show_contacts2($conf,$langs,$db,$object,$_SERVER["PHP_SELF"].'?socid='.$object->id);    // **p** um auf die card2.php in show_contacts2 umbenannt
	        }
