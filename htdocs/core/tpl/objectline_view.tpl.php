...
if (!empty($extrafieldsline))
{
	//print $line->showOptionals($extrafieldsline,'view',array('style'=>$bcdd[$var],'colspan'=>$coldisplay));
        print '</tr><tr><td colspan="9"><div id="accordion" class="accordion">';// angefügt
        print $line->showOptionals2($extrafieldsline,'view',array('style'=>$bcdd[$var],'colspan'=>$coldisplay));// angefügt
        print '</div></td>';                                                    //angefügt
}
?>
