 ...
 *      @return	void
 */
function show_contacts2($conf,$langs,$db,$object,$backtopage='')        //**p** function show_contacts kopiert und in function show_contacts2 umbenannt card in card2.php
{
    global $user,$conf;
    global $bc;
    ...
    {
    	$addcontact = (! empty($conf->global->SOCIETE_ADDRESSES_MANAGEMENT) ? $langs->trans("AddContact") : $langs->trans("AddContactAddress"));
		$buttoncreate='<a class="addnewrecord" href="'.DOL_URL_ROOT.'/contact/card2.php?socid='.$object->id.'&amp;action=create&amp;backtopage='.urlencode($backtopage).'">'.$addcontact;
		if (empty($conf->dol_optimize_smallscreen)) $buttoncreate.=' '.img_picto($addcontact,'filenew');
		$buttoncreate.='</a>'."\n";
    }
	...
	if ($num || (GETPOST('button_search') || GETPOST('button_search.x') || GETPOST('button_search_x')))
    {
        ...
        while ($i < $num)
        {
            ...
            {
                print '<td align="right">';
                print '<a href="'.DOL_URL_ROOT.'/contact/card2.php?action=edit&amp;id='.$obj->rowid.'&amp;backtopage='.urlencode($backtopage).'">';
                print img_edit();
                print '</a></td>';
            }
            else print '<td>&nbsp;</td>';
 ...
 *      @return	void
 */
function show_contacts3($conf,$langs,$db,$object,$backtopage='')        //**p** function show_contacts kopiert und in function show_contacts2 umbenannt card in card2.php
{
    global $user,$conf;
    global $bc;
    ...
    {
    	$addcontact = (! empty($conf->global->SOCIETE_ADDRESSES_MANAGEMENT) ? $langs->trans("AddContact") : $langs->trans("AddContactAddress"));
		$buttoncreate='<a class="addnewrecord" href="'.DOL_URL_ROOT.'/contact/card3.php?socid='.$object->id.'&amp;action=create&amp;backtopage='.urlencode($backtopage).'">'.$addcontact;
		if (empty($conf->dol_optimize_smallscreen)) $buttoncreate.=' '.img_picto($addcontact,'filenew');
		$buttoncreate.='</a>'."\n";
    }
	...
	if ($num || (GETPOST('button_search') || GETPOST('button_search.x') || GETPOST('button_search_x')))
    {
        ...
        while ($i < $num)
        {
            ...
            {
                print '<td align="right">';
                print '<a href="'.DOL_URL_ROOT.'/contact/card3.php?action=edit&amp;id='.$obj->rowid.'&amp;backtopage='.urlencode($backtopage).'">';
                print img_edit();
                print '</a></td>';
            }
            else print '<td>&nbsp;</td>';
 ...
 *      @return	void
 */
function show_contacts4($conf,$langs,$db,$object,$backtopage='')        //**p** function show_contacts kopiert und in function show_contacts2 umbenannt card in card2.php
{
    global $user,$conf;
    global $bc;
    ...
    {
    	$addcontact = (! empty($conf->global->SOCIETE_ADDRESSES_MANAGEMENT) ? $langs->trans("AddContact") : $langs->trans("AddContactAddress"));
		$buttoncreate='<a class="addnewrecord" href="'.DOL_URL_ROOT.'/contact/card4.php?socid='.$object->id.'&amp;action=create&amp;backtopage='.urlencode($backtopage).'">'.$addcontact;
		if (empty($conf->dol_optimize_smallscreen)) $buttoncreate.=' '.img_picto($addcontact,'filenew');
		$buttoncreate.='</a>'."\n";
    }
	...
	if ($num || (GETPOST('button_search') || GETPOST('button_search.x') || GETPOST('button_search_x')))
    {
        ...
        while ($i < $num)
        {
            ...
            {
                print '<td align="right">';
                print '<a href="'.DOL_URL_ROOT.'/contact/card4.php?action=edit&amp;id='.$obj->rowid.'&amp;backtopage='.urlencode($backtopage).'">';
                print img_edit();
                print '</a></td>';
            }
            else print '<td>&nbsp;</td>';
